...
<html lang="en">
    ...
    <form action="" method="post">
        <div class="formRow">
            ...
            <select name="category_id" id="category_id" class="formInput">
                ...
                <?php foreach ($categories as $category): ?>
                    <option <?= intval($_POST['category_id']) == $category['id'] ? 'selected' : '' ?> value="<?= $category['id']; ?>"><?= $category['category_name'] ?></option>
                <?php endforeach; ?>
                <?php endif; ?>
            </select>
        </div>
        <div class="formRow">
            ...
            <?php if (!is_null($snack_name_error)): ?>
            <p class="formError"><?= $snack_name_error ?></p>
            <?php endif; ?>
        </div>
        <div class="formRow">
            <label for="snack_description">Snack Description *</label>
            ...
            <?php if (!is_null($snack_description_error)): ?>
